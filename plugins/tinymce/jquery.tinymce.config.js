$(function() {
	...
	var tinymce_options = {
		...
		plugins : [ "responsivefilemanager,table,image,imagetools,charmap,link,code,textcolor,searchreplace,visualchars" ],
    	...
    	//paste_retain_style_properties: "color font-size font-color background background-color letter-spacing",
